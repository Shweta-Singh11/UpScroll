  ...
  const games = [
    {
      title: "Sudoku",
      description:
        "Classical 9x9 grid puzzles to test your logical deduction skills.",
    ...
    },
    {
      title: "Word Search",
      description:
        "Find hidden patterns in a sea of letters to boost your recognition.",
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <header className="text-center mb-20 space-y-4">
          ...
          <p className="text-zinc-400 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed">
            Select a quest to sharpen your cognitive functions and clear the
            digital void.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-center">
          {games.map((game, index) => (
            ...
            >
              ...
              >
                <div
                  className={`w-16 h-16 mb-6 rounded-2xl flex items-center justify-center bg-linear-to-br ${game.bgColor} 
              ...
              <div
                className={`absolute inset-0 -z-10 bg-linear-to-br ${game.bgColor} opacity-0 group-hover:opacity-20 blur-3xl transition-opacity duration-500 rounded-[2.5rem]`}
              ></div>
            </div>
          ))}
        </div>
