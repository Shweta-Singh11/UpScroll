  ...
  const fetchBrainByte = async () => {
    ...
    try {
      const response = await fetch(
        "https://brain-backend-2-5onn.onrender.com/api/facts/random",
      );
          ...
          <div className="w-full lg:w-1/2 flex justify-center items-center relative">
            ...
            <div className="relative z-10 p-12 rounded-[4rem] bg-linear-to-br from-white/5 to-transparent border border-white/10 shadow-2xl backdrop-blur-sm">
              <div className="relative">
                <BrainCircuit
                  size={200}
                  className="text-violet-400 drop-shadow-[0_0_25px_rgba(167,139,250,0.5)]"
                />
                <Zap
                  size={40}
                  className="absolute -top-4 -right-4 text-cyan-400 animate-bounce fill-cyan-400"
                />
              </div>
          ...
          <div className="w-full lg:w-1/2 space-y-8">
            <header>
              ...
              <h1 className="text-6xl md:text-8xl font-black uppercase italic tracking-tighter leading-[0.8] mb-4">
                FACT
                <br />
                <span className="bg-linear-to-r from-violet-400 to-cyan-400 bg-clip-text text-transparent pr-4">
                  STATION
                </span>
              </h1>
