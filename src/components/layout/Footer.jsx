        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-zinc-400 text-lg max-w-sm leading-relaxed">
              Find your own interests and will. Explore the depths of your
              potential and reclaim your attention.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-6 text-2xl">
              <a
                href="#"
                aria-label="Facebook"
                className="text-zinc-400 hover:text-blue-500 transition-all transform hover:-translate-y-1"
              >
              ...
              <a
                href="#"
                aria-label="Twitter"
                className="text-zinc-400 hover:text-sky-400 transition-all transform hover:-translate-y-1"
              >
              ...
              <a
                ...
                className="text-zinc-400 hover:text-pink-600 transition-all transform hover:-translate-y-1"
              >
              ...
              <a
                href="#"
                aria-label="LinkedIn"
                className="text-zinc-400 hover:text-blue-400 transition-all transform hover:-translate-y-1"
              >
                <i className="fa-brands fa-linkedin-in"></i>
              </a>
            </div>
            <p className="pt-10 text-sm font-medium text-zinc-400 italic">
              With ❤️ <span className="text-zinc-200">Shweta</span> and{" "}
              <span className="text-zinc-200">Tusharika </span>
            </p>
          </div>
        </div>
